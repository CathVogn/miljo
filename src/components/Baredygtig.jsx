...
export default function Baredygtig(){
    ...
    <div className="baredygtig-kol">
         <img src={linje2} id="linje2" alt="globus" />
        <div className="hver-enkeltkort">
            <h3>Kode</h3>
            <img src={kode} alt="kode" />
    ...
    <div className="baredygtig-kol">
        <div className="hver-enkeltkort">
            <h3>Page Load</h3>
            <img src={pageloade} alt="pageloade" />
    ...
    <div className="baredygtig-kol">
        <div className="hver-enkeltkort">
            ...
            <img src={strom} id="strom" alt="strom" />
